...
```
https://wigglez-sudo.github.io/nvidia-ai-desktop/?v=3.1.5
```
...
The Worker source is still a single file: **`worker/index.js`**. Its behaviour is unchanged in v3.1.5. **No Worker change is required for this patch** unless you want to redeploy the included copy for consistency.
...
After uploading, open the site with `?v=3.1.5` and check:
...
4. Sidebar name/status (bottom-left) opens **App Status & Tools**; version badge shows `v3.1.5`.
